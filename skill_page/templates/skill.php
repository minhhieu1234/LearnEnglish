    ...
    <div class="region-content-container">
      <section id="block-fixed-block-content-homepage-banner"
        ...
        <div class="block-content block-content--type-blurb-block block-content--view-mode-banner ds-1col clearfix">
          ...
          <div class="block-banner-header">
            <h2>Skill</h2>
            <p>
              Revise and practise your skill to help you increase your confidence and improve your
              language level.
            </p>
          </div>
        </div>
      ...
      <section class="wrapper-content-summary block block-content" id="block-homepage-intro">
        <div class="field field--name-body">
          <p>
            Reading: help improve your grammar knowledge. It also expands vocabulary and understanding. And also absorb more information and knowledge about the world around them. </p>
          <p>
            Writing: help you communicate letters with people easily. It also helps to fully communicate the necessary messages. It is one of the important skills in the work environment. Most especially office people, paper departments.
          </p>
          <p>
            Speaking: as well as communication skills: is an extremely important skill in study, work and life. Only by possessing this skill can you communicate ideas. You can also give a smooth and successful presentation or negotiation.
          </p>
          <p>Listening: helps you better understand the conversation or what's going on around you. It also puts you in touch with a variety of voices. For some time, you can listen to radio, foreign programs, ... without having to go through the translation.</p>
                      ...
                      <div class="layout__region layout__region--content">
                        ...
                        <div class="content-wrapper">
                          <div
                            ...
                            <h2>
                              <a href="../templates/listening.php">Listening</a>
                            </h2>
                          </div>
                          <div
                      ...
                      <div class="layout__region layout__region--content">
                        ...
                        <div class="content-wrapper">
                          <div
                            class="field field--name-taxonomy-term-title field--type-ds field--label-hidden field--item">
                            <h2>
                              <a href="../../skill_page/templates/speaking.php">Speaking</a>
                            </h2>
                          </div>
                      ...
                      <div class="layout__region layout__region--content">
                        ...
                        <div class="content-wrapper">
                          <div
                            class="field field--name-taxonomy-term-title field--type-ds field--label-hidden field--item">
                            <h2>
                              <a href="../../skill_page/templates/reading.php">Reading</a>
                            </h2>
                          </div>
                          <div class="field field--name-field-text-teaser field--type-string-long field--label-hidden field--item">
                      ...
                      <div class="layout__region layout__region--content">
                        ...
                        <div class="content-wrapper">
                          <div
                            class="field field--name-taxonomy-term-title field--type-ds field--label-hidden field--item">
                            <h2>
                              <a href="../../skill_page/templates/writing.php">Writing</a>
                            </h2>
                          </div>
                          <div class="field field--name-field-text-teaser field--type-string-long field--label-hidden field--item">
      ...
      <div class="block-block-link-term">
        <div class="block-link-container">
          <ul class="menu-navbar">
            <li>
              <a href="../templates" class="menu-navbar-btn--seperate navbar-btn-1">Listening</a>
            </li>
            <li>
