    ...
    <div class="region-content-container">
      <section id="block-fixed-block-content-homepage-banner"
        ...
        <div class="block-content block-content--type-blurb-block block-content--view-mode-banner ds-1col clearfix">
          ...
          <div class="block-banner-header">
            <h2>Writing</h2>
            <p>
              Enhance your confidence and elevate your language proficiency by refining and engaging in exercises to practice and improve your writing abilities.
            </p>
          </div>
        </div>
      </section>
      <section class="wrapper-content-summary block block-content" id="block-homepage-intro">
        <div class="field field--name-body">
          <p>
            Discover a range of activities designed to enhance your speaking abilities. By observing language patterns used in various contexts and engaging in exercises featuring practical expressions, you can enhance your spoken communication.
            <p>
            The self-guided lessons in this section are meticulously structured according to your English proficiency level, aligned with the Common European Framework of Reference for Languages (CEFR). These lessons incorporate diverse workplace conversations captured in videos, along with interactive exercises aimed at refining your conversational skills for professional success and effective communication in English. The videos facilitate practice of essential language usage, while the interactive exercises reinforce your retention and application of phrases.
            </p>
          <p>
            Take our complimentary online English assessment to determine your suitable proficiency level. Choose from A1 (elementary) to B2 (upper intermediate) English levels and enhance your speaking prowess at your own pace, whenever it suits you.
          </p>
                      ...
                      <div class="layout__region layout__region--content">
                        ...
                        <div class="content-wrapper">
                          <div
                            ...
                            <h2>
                              <a href="/grammar_page/templates/templates_c1/a1-a2-grammar.html">A1 Writing</a>
                            </h2>
                          </div>
                          <div
                      ...
                      <div class="layout__region layout__region--content">
                        ...
                        <div class="content-wrapper">
                          <div
                            class="field field--name-taxonomy-term-title field--type-ds field--label-hidden field--item">
                            <h2>
                              <a href="/grammar_page/templates/templates_c1/b1-b2-grammar.html">A2 Writing</a>
                            </h2>
                          </div>
                          <div class="field field--name-field-text-teaser field--type-string-long field--label-hidden field--item">
                            Speaking practice is a way to practice talking and using words that are helpful for everyday talking. You can learn how to show you are interested in what someone is saying, talk about where you come from, and talk about the work you do.
                          </div>
                        </div>
                      </div>
                    </div>  
                      ...
                      <div class="layout__region layout__region--content">
                        ...
                        <div class="content-wrapper">
                          <div
                            class="field field--name-taxonomy-term-title field--type-ds field--label-hidden field--item">
                            <h2>
                              <a href="/grammar_page/templates/templates_c1/b1-b2-grammar.html">B1 Writing</a>
                            </h2>
                          </div>
                          <div class="field field--name-field-text-teaser field--type-string-long field--label-hidden field--item">
                            Practicing speaking to help you learn words and phrases that you can use in everyday situations. This includes learning how to respond to news, talk to someone in person, and ask for help.
                          </div>
                        </div>
                      </div>
                    </div>  
                      ...
                      <div class="layout__region layout__region--content">
                        ...
                        <div class="content-wrapper">
                          <div
                            class="field field--name-taxonomy-term-title field--type-ds field--label-hidden field--item">
                            <h2>
                              <a href="/grammar_page/templates/templates_c1/b1-b2-grammar.html">B2 Writing</a>
                            </h2>
                          </div>
                          <div class="field field--name-field-text-teaser field--type-string-long field--label-hidden field--item">
                            Speaking practice is when you practice talking to learn words and phrases that you can use in everyday conversations. You practice how to give advice, handle problems, and politely disagree with someone's thoughts.
                          </div>
                        </div>
                      </div>
                    </div>  
