  ...
  <header class="navbar-header">
    ...
    <div class="region-content-container">
      ...
      <section class="wrapper-content-summary block block-content" id="block-homepage-intro">
        ...
        Are you currently at the A1 English level (elementary)? This section provides opportunities for practicing reading to aid you in learning and honing valuable phrases that contribute to clear and effective English communication.
            <p>
                      ...
                      <div class="layout__region layout__region--content">
                        ...
                        <div class="content-wrapper">
                          <div
                            ...
                            <h2>
                              <a href="../templates/.php">A poster at work</a>
                            </h2>
                          </div>
                          <div
                      ...
                      <div class="layout__region layout__region--content">
                        ...
                        <div class="content-wrapper">
                          <div
                            class="field field--name-taxonomy-term-title field--type-ds field--label-hidden field--item">
                            <h2>
                              <a href="../../skill_page/templates/speaking.php">A restaurant menu</a>
                            </h2>
                          </div>
                      ...
                      <div class="layout__region layout__region--content">
                        ...
                        <div class="content-wrapper">
                          <div
                            class="field field--name-taxonomy-term-title field--type-ds field--label-hidden field--item">
                            <h2>
                              <a href="../../skill_page/templates/reading.php">A study timetable</a>
                            </h2>
                          </div>
                          <div class="field field--name-field-text-teaser field--type-string-long field--label-hidden field--item">
                      ...
                      <div class="layout__region layout__region--content">
                        ...
                        <div class="content-wrapper">
                          <div
                            class="field field--name-taxonomy-term-title field--type-ds field--label-hidden field--item">
                            <h2>
                              <a href="../../skill_page/templates/writing.php">Notes at work</a>
                            </h2>
                          </div>
                          <div class="field field--name-field-text-teaser field--type-string-long field--label-hidden field--item">
      ...
      <div class="block-block-navbar-container">
        <div class="left-side">
            <div class="block-left-image">
                <img src="../img/4.5.jpg" alt="" class="img-responsive">
            </div>
        </div>
        <div class="right-side">
