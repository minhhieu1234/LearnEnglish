      ...
      <section id="block-fixed-block-content-homepage-banner"
        ...
        <div class="block-content block-content--type-blurb-block block-content--view-mode-banner ds-1col clearfix">
          ...
          <div class="block-banner-header">
            <h2>Reading</h2>
            <p>
              Enhance your confidence and elevate your language proficiency by refining and engaging in exercises to practice and improve your speaking abilities.
            </p>
          </div>
        </div>
      </section>
                      ...
                      <div class="layout__region layout__region--content">
                        ...
                        <div class="content-wrapper">
                          <div
                            ...
                            <h2>
                              <a href="../templates/readingA1.php">A1 Reading</a>
                            </h2>
                          </div>
                          <div
                      ...
                      <div class="layout__region layout__region--content">
                        ...
                        <div class="content-wrapper">
                          <div
                            class="field field--name-taxonomy-term-title field--type-ds field--label-hidden field--item">
                            <h2>
                              <a href="../templates/readingA2.php">A2 Reading</a>
                            </h2>
                          </div>
                      ...
                      <div class="layout__region layout__region--content">
                        ...
                        <div class="content-wrapper">
                          <div
                            class="field field--name-taxonomy-term-title field--type-ds field--label-hidden field--item">
                            <h2>
                              <a href="../templates/readingB1.php">B1 Reading</a>
                            </h2>
                          </div>
                          <div class="field field--name-field-text-teaser field--type-string-long field--label-hidden field--item">
                      ...
                      <div class="layout__region layout__region--content">
                        ...
                        <div class="content-wrapper">
                          <div
                            class="field field--name-taxonomy-term-title field--type-ds field--label-hidden field--item">
                            <h2>
                              <a href="../templates/readingB2.php">B2 Reading</a>
                            </h2>
                          </div>
                          <div class="field field--name-field-text-teaser field--type-string-long field--label-hidden field--item">
      ...
      <div class="block-block-navbar-container">
        <div class="left-side">
            <div class="block-left-image">
                <img src="../img/5.1.jpeg" alt="" class="img-responsive">
            </div>
        </div>
        <div class="right-side">
