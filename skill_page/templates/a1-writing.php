...
<body>
  <div class="wrapper">
    ...
    <a href="">Skills > Writing > A1 writing</a>
    <h1>A1 writing</h1>
    <div class="region-content-container">
      <section id="block-fixed-block-content-homepage-banner"
        ...
        <div class="field field--name-body">
          <p>
            Are you a learner at A1 English level (elementary)? This section offers writing practice to help you write short, simple texts about known topics and fill in forms. Texts include messages, emails and forms.
            <p>
          <h2>Choose a writing lesson</h2>     
        </div>
      </section>
                      ...
                      <div class="layout__region layout__region--content">
                        ...
                        <div class="content-wrapper">
                          <div
                            ...
                            <h2>
                              <a href="/grammar_page/templates/templates_c1/a1-a2-grammar.html">A message to say you're late</a>
                            </h2>
                          </div>
                          <div
                      ...
                      <div class="layout__region layout__region--content">
                        ...
                        <div class="content-wrapper">
                          <div
                            class="field field--name-taxonomy-term-title field--type-ds field--label-hidden field--item">
                            <h2>
                              <a href="/grammar_page/templates/templates_c1/b1-b2-grammar.html">A noticeboard message</a>
                            </h2>
                          </div>
                      ...
                      <div class="layout__region layout__region--content">
                        ...
                        <div class="content-wrapper">
                          <div
                            class="field field--name-taxonomy-term-title field--type-ds field--label-hidden field--item">
                            <h2>
                              <a href="/grammar_page/templates/templates_c1/b1-b2-grammar.html">A text message invitation</a>
                            </h2>
                          </div>
                          <div class="field field--name-field-text-teaser field--type-string-long field--label-hidden field--item">
                      ...
                      <div class="layout__region layout__region--content">
                        ...
                        <div class="content-wrapper">
                          <div
                            class="field field--name-taxonomy-term-title field--type-ds field--label-hidden field--item">
                            <h2>
                              <a href="/grammar_page/templates/templates_c1/b1-b2-grammar.html">A thank-you email</a>
                            </h2>
                          </div>
                          <div class="field field--name-field-text-teaser field--type-string-long field--label-hidden field--item">
        ...
        <div class="right-side">
          <div class="box-right">
            <nav role="navigation" aria-labelledby="block-system-menu-block-website-links-menu" id="block-system-menu-block-website-links" class="aside-content">
              <h2 id="block-system-menu-block-website-links-menu">Writing</h2>
                <ul class="menu menu--website-links nav2">
                   <li class="first">
                      <a href="https://learnenglishteens.britishcouncil.org"><i class="fa-solid fa-check"></i>A1 writing</a>
                  </li>
  
                  <li>
                    <a href="https://learnenglishteens.britishcouncil.org"><i class="fa-solid fa-check"></i>A2 writing</a>
                  </li>
                  
                  <li>
                      <a href="https://learnenglishteens.britishcouncil.org"><i class="fa-solid fa-check"></i>B1 writing</a>
                  </li>
                  <li>
                    <a href="https://learnenglishteens.britishcouncil.org"><i class="fa-solid fa-check"></i>B2 writing</a>
                  </li>
                </ul>
