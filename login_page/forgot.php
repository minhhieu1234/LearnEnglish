...
if (!$con = mysqli_connect("localhost", "root", "", "hihi")) {
		...
		case 'enter_email':
			...
			<section class="portal">
				<form method="post" action="forgot.php?mode=enter_email">
					...
					<button type="submit" value="Next" class="submit">Next</button>
					<br>
					<div class='login'>
					You have account?
		...
		case 'enter_code':
			...
			<section class='portal'>
				<form method="post" action="forgot.php?mode=enter_code">
					...
					<div class="input-field"><input class="textbox" type="text" name="code" placeholder="12345"></div>
